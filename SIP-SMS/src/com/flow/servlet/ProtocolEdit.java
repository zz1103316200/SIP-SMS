...
public class ProtocolEdit extends HttpServlet {
	...
	/*	String protocolId = "5";
		...
		String protocolId = (String)request.getParameter("ProtocolID");//获得协议组件的Id
		String protocolName = (String)request.getParameter("ProtocolName");//获得修改后的组件名称
		String description = (String)request.getParameter("ProtocolDescription");//获得修改后的协议组件描述
